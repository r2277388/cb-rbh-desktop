...
ACTIONS: dict[str, Action] = {
    ...
    "amazon_monthly_sales": Action(
        ...
        "Add new Monthly file to Cache (monthly step 1)",
    ...
    "amazon_monthly_rolling_reports": Action(
        ...
        "Run Monthly Rolling Report (monthly step 2)",
    ...
    "gen_editorial_automation_status": Action(
        ...
        "Show the Monday General Editorial archive/report scheduled task status.",
        "Automation Processes",
    ),
    "gen_editorial_automation_register": Action(
        ...
        "Create or update the Monday General Editorial archive/report scheduled task.",
        "Automation Processes",
    ),
