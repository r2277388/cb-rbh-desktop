...
# Process the inventory data and save the results to an Excel file
df_result_inventory = process_inventory(df_inventory, dict_cdu, dict_uc)

## Save the result dataframe to an Excel file
output_file_path = r'C:\Users\rbh\Desktop\consolidated_inventory.xlsx'
df_result_inventory.to_excel(output_file_path, index=False)

# Display the result dataframe
print(df_result_inventory[df_result_inventory['ISBN']=='0810073341821'])
print(df_result_inventory.info())